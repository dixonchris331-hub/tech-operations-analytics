...
- **repair_events** — Information about device failures, repair dates, repair status, and failure types.
- **upload_events** — Information about device uploads, upload dates, data size, and upload status.
